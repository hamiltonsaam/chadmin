...
<!-- ====== FILING SIDEBAR ====== -->
<nav class="company-sidebar" id="companySidebar" aria-label="Filing navigation">
    ...
    <div class="company-sidebar-top">
        <div class="brand-logo">
            <img src="/chadmin/views/theme/layout/logo.png" alt="A1A eFiling" class="brand-img" loading="lazy" width="120" height="40">
        </div>
    </div>
...
<main class="company-main">
    <div class="company-content">
        ...
        <!-- TWO-COLUMN: Registered Office + Registered Email -->
        <div class="web-filing-two-column">
        ...
        <div class="card">
            ...
            <div class="info-grid">
                ...
                <div class="info-box">
                    ...
                    <div class="info-value" style="color:<?= $filingAccessValid ? '#22ff00' : '#ff0000' ?>;">  
                        <?= $filingAccessValid ? 'Connected and valid' : 'Not connected / expired' ?>
                    </div>
                </div>
                <div class="info-box">
