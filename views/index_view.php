...
<div class="stat-grid">
  ...
  <div class="stat-card">
    ...
    <p class="stat-value stat-err"><?= (int) ($todoCounts['red'] ?? 0) ?></p>
  </div>
  <div class="stat-card">
    <p class="stat-label">Due Soon</p>
    <p class="stat-value stat-warn"><?= (int) ($todoCounts['due_soon'] ?? 0) ?></p>
  </div>
  <div class="stat-card">
    <p class="stat-label">Up to Date</p>
    <p class="stat-value stat-up"><?= (int) ($todoCounts['ok'] ?? 0) ?></p>
  </div>
  <div class="stat-card">
    <p class="stat-label">Dissolved</p>
    <p class="stat-value stat-err"><?= (int) ($todoCounts['brown'] ?? 0) ?></p>
  </div>
  <div class="stat-card">
    <p class="stat-label">Accounts Due</p>
    <p class="stat-value stat-warn"><?= (int) ($todoCounts['accounts'] ?? 0) ?></p>
  </div>
  <div class="stat-card">
    <p class="stat-label">Confirmation Due</p>
    <p class="stat-value stat-warn"><?= (int) ($todoCounts['confirmation'] ?? 0) ?></p>
  </div>
  <div class="stat-card">
